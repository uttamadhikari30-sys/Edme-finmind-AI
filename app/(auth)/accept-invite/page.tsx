...
export default function AcceptInvitePage() {
  ...
  // If user is already signed in and has a token, just call accept
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    // 2. If session exists now, accept the invite
    ...
    // 3. No session yet (email confirmation needed)
    setLoading(false);
    setInfo(
    ...
    <div className="bg-white rounded-2xl shadow-card border border-[var(--border)] p-9 animate-fade-up">
      <div className="text-center">
        ...
        <p className="text-[13px] text-ink-muted mt-1">
          Set up your FINMIND AI account.
        </p>
      </div>
